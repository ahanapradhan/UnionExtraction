...
class MyTestCase(BaseTestCase):
    extracted_U = "extracted_tech_report_queries"
    dat_filename = "tech_report_queries.dat"
    query_dir_path = "tech_report_queries"
    plot_script = "tech_report_queries.gnu"
    plot_filename = "tech_report_queries_plot.eps"
    latex_filename = "basic_queries_table.tex"
    testcase_filename = "paper_base_test.py"
