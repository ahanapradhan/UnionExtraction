...
The Query finds, from scanning the available stock of suppliers in India, all
...
SELECT <failed> FROM nation, supplier, partsupp
       WHERE supplier.s_nationkey = nation.n_nationkey AND supplier.s_suppkey = partsupp.ps_suppkey AND nation.n_name = 'INDIA'
