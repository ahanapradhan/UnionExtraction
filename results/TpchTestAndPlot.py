...
class MyTestCase(BaseTestCase):
    extracted_U = "tpch_queries"
    dat_filename = "tpch_queries.dat"
    plot_script = "tpch_queries.gnu"
    plot_filename = "tpch_queries_plot.eps"
    latex_filename = "tpch_queries_table.tex"
