...
Where c_nationkey = n_nationkey and c_custkey = o_custkey and l_orderkey = o_orderkey and o_orderdate  >= '1994-01-01' and o_orderdate <= '1994-03-31' and l_returnflag  = 'R'
