...
Where n_nationkey = c_nationkey and c_custkey = o_custkey and o_orderkey = l_orderkey and o_orderdate  >= '1994-01-01' and o_orderdate <= '1994-04-01' and l_returnflag  = 'R'
